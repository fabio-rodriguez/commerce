# Generated by Django 3.1 on 2020-10-01 15:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_url', models.CharField(default=None, max_length=256)),
                ('initial_bid', models.DecimalField(decimal_places=2, max_digits=8)),
                ('active', models.BooleanField(max_length=1)),
                ('date_creation', models.DateTimeField(auto_now_add=True)),
                ('auction_winner_id', models.IntegerField(blank=True, default=None)),
                ...
                ('users_watchlists', models.ManyToManyField(blank=True, related_name='watchlist', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
